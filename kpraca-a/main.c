...
int	main(void)
{
	...
	printf("%*d|    printf só '*d' w = 7\n", w, decimal);
     ft_printf("%*d| ft_printf so '*d' w = 7\n\n", w, decimal);

	printf("%0*d|    printf '0*d' w = 7\n", w, decimal);
     ft_printf("%0*d| ft_printf '0*d' w = 7\n\n", w, decimal);
	
	printf("%-*d|    printf '-*d' w = 7\n", w, decimal);
     ft_printf("%-*d| ft_printf '-*d' w = 7\n\n", w, decimal);

        printf("%*0d|    printf '*0d' w = 7\n", w, decimal);
     ft_printf("%*0d| ft_printf '*0d' w = 7\n\n", w, decimal);

        printf("%*5d|    printf '*5d' w = 7\n", w, decimal);
     ft_printf("%*5d| ft_printf '*5d' w = 7\n\n", w, decimal);

    	printf("%7*d|    printf '7*d' w = 7\n", w, decimal);
     ft_printf("%7*d| ft_printf '7*d' w = 7\n\n", w, decimal);

       	printf("%07*d|    printf '07*d' w = 7\n", w, decimal);    
     ft_printf("%07*d| ft_printf '07*d' w = 7\n\n", w, decimal);   

	
	printf("----Flag '*' só exceções -------------------------------------\n");
